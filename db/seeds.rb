...
puts "Loading plans.."
Plan.find_or_create_by name: "Freemium", description: "Free user with limits", amount: 0.00, plan_type: "Free", period: "monthly", brand_limit: 1, branch_limit: 3, duration_in_days: 2

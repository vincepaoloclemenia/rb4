class BranchesController < ApplicationController
	...
	def branch_params
		...
		params.require(:branch).permit(:name, :branch_type, :tin_number, :company_registered_name, :aka, :address1, :brand_id, :color, :city, :zip, :email_address, :landline_no, :mobile_no, :fax_no, :delivery_time, branch_tax_attributes: [ :id, :branch_id, :tax_type_id ])
	end
end
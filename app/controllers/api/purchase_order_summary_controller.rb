class Api::PurchaseOrderSummaryController < ApplicationController
    ...
    def index
        @approved_purchase_orders = current_brand.purchase_orders.approved_pos
        #@pending_pos = current_brand.purchase_orders.new_pos
    end

    def get_on_hold_pos
        @on_hold_pos = current_brand.purchase_orders.on_hold_pos
    end      
    
    def get_rejected_pos
        @rejected_pos = current_brand.purchase_orders.rejected_pos        
    end        

    def get_purchase_orders 
        @purchase_orders = current_user.branch.purchase_orders
    end

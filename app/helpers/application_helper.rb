module ApplicationHelper
	...
	def is_menu_open?(menu_name)
		...
		when "purchasing"
			"open" if current_pages?(purchase_order_generator_index_path, purchase_orders_path) || (controller.eql?('purchase_order_generator') && action.eql?('index')) || (controller.eql?('purchase_orders') && action.eql?('index'))
		when "labor_setup"

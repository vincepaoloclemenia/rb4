                ...
                purchaseOrders.map((po, index) => 
                    <tr key={index}>    
                        ...
                        <td className='action' data-title='Action'>
                            ...
                            <a className="btn btn-default btn-xs mb10 mr2" data-tt="tooltip" data-placement="top" data-original-title="Hold" rel="nofollow" data-method="patch" href={`/purchase_orders/${po.id}/hold`} aria-describedby="tooltip63628"><i className="fa blue icon-glyph-28 f14"></i></a>

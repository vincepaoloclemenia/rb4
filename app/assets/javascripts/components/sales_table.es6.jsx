                ...
                {this.state.sales.map ((sale) =>
                    <tr className="animated-row" key={sale.id}>
                        ...
                        <td className="action" data-sortable="false" data-title="Action">
                            ...
                            <a className="btn btn-default btn-xs mb10 mr2" data-tt="tooltip" data-placement="top" data-original-title="Delete" rel="nofollow" data-method="delete" href={`/sales/${sale.id}`}>

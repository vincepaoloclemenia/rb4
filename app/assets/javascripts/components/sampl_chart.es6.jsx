class SamplChart extends React.Component{
    constructor(props){
        super(props)
        this.myData={
            chart:
                {"caption":"Actual Revenues, Targeted Revenues & Profits","subcaption":"Last year","xaxisname":"Month","yaxisname":"Amount (In USD)","numberprefix":"$","theme":"ocean"},

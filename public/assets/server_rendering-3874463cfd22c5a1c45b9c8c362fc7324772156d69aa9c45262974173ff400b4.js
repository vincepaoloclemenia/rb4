...
var CostAnalysis = (function (_React$Component) {
    _inherits(CostAnalysis, _React$Component);

    function CostAnalysis(props) {
        _classCallCheck(this, CostAnalysis);

        _get(Object.getPrototypeOf(CostAnalysis.prototype), 'constructor', this).call(this, props);
        this.state = {
            fetching: false,
            display: 'week',
            purchasesLastWeek: [],

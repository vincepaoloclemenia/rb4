...
var ActivitiesContainer = (function (_React$Component) {
    _inherits(ActivitiesContainer, _React$Component);

    function ActivitiesContainer(props) {
        _classCallCheck(this, ActivitiesContainer);

        _get(Object.getPrototypeOf(ActivitiesContainer.prototype), "constructor", this).call(this, props);
        this.state = { recentActivities: [], nextPage: null, fetchingData: false };
    }

    _createClass(ActivitiesContainer, [{
        ...
        value: function listOfActivities() {
            var _this = this;

            if (this.state.fetchingData) {
                return React.createElement(
                    "div",
                    { className: "fetching-activities" },
        ...
        value: function handleScroll() {
            var scrollHeight = $(this.activitysListRef)[0].scrollHeight;
            var OFFSET = 50;
            var scrollTop = $(this.activitysListRef).scrollTop();
        ...
        value: function handleLoadMore() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    _this3.setState({
                        nextPage: data.next_page,
                        recentActivities: [].concat(_toConsumableArray(_this3.state.recentActivities), _toConsumableArray(data.activities))
                    });
                }
            });
        }
        ...
        key: "renderActivityItem",
        value: function renderActivityItem() {
            ...
            return this.state.recentActivities.map(function (activity) {
                return React.createElement(ActivityItem, _extends({ key: activity.id }, activity));
            });
        }
    }]);
...
var ActivityItem = (function (_React$Component) {
    ...
    _createClass(ActivityItem, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                { className: 'activit-item' },
                React.createElement(
                    'li',
                    { className: 'activity-item-link', style: borderStyles },
                    React.createElement(
                        'a',
                        { href: this.props.url },
                        React.createElement('span', { dangerouslySetInnerHTML: { __html: this.props.avatar } }),
                        React.createElement(
                            'div',
        ...
        key: 'activityContent',
        value: function activityContent() {
            var _props = this.props;
            var doer = _props.doer;
        ...
        key: 'activityIcon',
        value: function activityIcon() {
            switch (this.props.type) {
                case 'sale':
                    return React.createElement('i', { className: 'fa fa-usd' });
                case 'purchase item':
                    return React.createElement('i', { className: 'fa fa-shopping-cart', 'aria-hidden': 'true' });
            }
        }
    }]);
...
var AdminsContainer = (function (_React$Component) {
    _inherits(AdminsContainer, _React$Component);

    function AdminsContainer(props) {
        _classCallCheck(this, AdminsContainer);

        _get(Object.getPrototypeOf(AdminsContainer.prototype), "constructor", this).call(this, props);
        this.state = {
            fetching: false,
            companyAdmins: [],
            branchAdmins: [],
    ...
    _createClass(AdminsContainer, [{
        ...
        key: "renderCompanyAdmins",
        value: function renderCompanyAdmins() {
            return React.createElement(
                "div",
                { className: "row mb5" },
                React.createElement(
                ...
                React.createElement("br", null),
                React.createElement(AdminsPerRole, { status: this.state.fetching, admins: this.state.companyAdmins })
            );
        }
    }, {
        key: "renderBrandAdmins",
        value: function renderBrandAdmins() {
            return React.createElement(
                "div",
                { className: "row mb5" },
                React.createElement(
                ...
                React.createElement("br", null),
                React.createElement(AdminsPerRole, { status: this.state.fetching, admins: this.state.brandAdmins })
            );
        }
    }, {
        key: "renderBranchAdmins",
        value: function renderBranchAdmins() {
            return React.createElement(
                "div",
                { className: "row mb5" },
                React.createElement(
                ...
                React.createElement("br", null),
                React.createElement(AdminsPerRole, { status: this.state.fetching, admins: this.state.branchAdmins })
            );
        }
    }, {
        key: "fetchCompanyUsers",
        value: function fetchCompanyUsers() {
            var _this = this;
...
var AdminsPerRole = (function (_React$Component) {
    _inherits(AdminsPerRole, _React$Component);

    function AdminsPerRole(props) {
        _classCallCheck(this, AdminsPerRole);

        _get(Object.getPrototypeOf(AdminsPerRole.prototype), 'constructor', this).call(this, props);
    }

    _createClass(AdminsPerRole, [{
        key: 'recognizeLength',
        value: function recognizeLength() {
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                { className: this.recognizeLength() },
                this.props.admins.map(function (admin) {
                    return React.createElement(
                        'div',
                        { key: admin.id, className: _this.cardWidth() },
                        React.createElement(
                            'div',
                            { className: 'card', style: { backgroundColor: admin.color, color: 'white' } },
                            React.createElement(
                                'center',
                                null,
                                React.createElement('span', { dangerouslySetInnerHTML: { __html: admin.avatar } })
                            ),
                            React.createElement(
                                'div',
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'a',
                                        { className: 'btn btn-transparent btn-xs mb10 mr2', 'data-tt': 'tooltip', 'data-placement': 'top', 'data-original-title': 'Edit User', 'data-remote': 'true', href: '/company_users/' + admin.id + '/edit' },
                                        React.createElement('i', { className: 'fa fa-pencil-square-o', 'aria-hidden': 'true' })
                                    ),
                                    React.createElement(
                                        'a',
                                        { className: 'btn btn-transparent btn-xs mb10 mr2', 'data-tt': 'tooltip', 'data-placement': 'top', 'data-original-title': 'Delete', 'data-confirm': 'Are you sure?', rel: 'nofollow', 'data-method': 'delete', href: '/company_users/' + admin.id },
...
var BranchSalesTable = (function (_React$Component) {
    _inherits(BranchSalesTable, _React$Component);

    function BranchSalesTable(props) {
        _classCallCheck(this, BranchSalesTable);

        _get(Object.getPrototypeOf(BranchSalesTable.prototype), "constructor", this).call(this, props);
        this.state = {
            sales: [], nextPage: null
        };
    }

    _createClass(BranchSalesTable, [{
        key: "componentWillMount",
        value: function componentWillMount() {
            this.fetchSales();
        }
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    "table",
                    { className: "table table-bordered table-striped mb0", "data-sortable": "", "data-sortable-initialized": "true" },
                    React.createElement(
                        "thead",
                        null,
                        React.createElement(
        ...
        value: function renderTableData() {
            return React.createElement(
                ...
                this.state.sales.map(function (sale) {
                    return React.createElement(
                        "tr",
                        { className: "animated-row", key: sale.id },
                        React.createElement(
                            "td",
                            { "data-title": "Date" },
                            sale.date
                        ...
                        React.createElement(
                            "td",
                            { "data-title": "Settlement Type Sales" },
                            sale.settlement
                        ),
                        React.createElement(
                            "td",
                            { "data-title": "Cash for Deposits" },
                            sale.deposits
                        ),
                        React.createElement(
                            "td",
                            { className: "action", "data-sortable": "false", "data-title": "Action" },
                            React.createElement(
                                "a",
                                { className: "btn btn-default btn-xs mb10 mr2", "data-tt": "tooltip", "data-placement": "top", "data-original-title": "View Sales", href: "/sales/" + sale.id },
                                React.createElement("i", { className: "icon-glyph-41 f14" })
                            ),
                            React.createElement(
                                "a",
                                { className: "btn btn-default btn-xs mb10 mr2", "data-tt": "tooltip", "data-placement": "top", "data-original-title": "Delete", "data-confirm": "Are you sure?", rel: "nofollow", "data-method": "delete", href: "/sales/" + sale.id },
                                React.createElement("i", { className: "icon-glyph-76 f14" })
                            )
                        )
                    );
                })
        ...
        value: function loadMoreButton() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "a",
                        { className: "see-more-table", onClick: function () {
                                return _this2.handleLoadMore();
                            } },
                        "See More",
                        React.createElement("i", { className: "fa " + (this.fetching ? 'fa-spinnerfa-pulse' : '') })
                    )
                )
            );
        }
        ...
        value: function handleLoadMore() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    _this3.setState({
                        nextPage: data.next_page,
                        sales: [].concat(_toConsumableArray(_this3.state.sales), _toConsumableArray(data.sales))
                    });
                }
            });
        }
...
var CustomerCountDashboard = (function (_React$Component) {
    _inherits(CustomerCountDashboard, _React$Component);

    function CustomerCountDashboard(props) {
        _classCallCheck(this, CustomerCountDashboard);

        _get(Object.getPrototypeOf(CustomerCountDashboard.prototype), 'constructor', this).call(this, props);
        this.state = {
            averageCount: 0, fetching: false, lastWeekCount: 0, countPercentage: 0
        };
    }

    _createClass(CustomerCountDashboard, [{
        key: 'componentWillMount',
        value: function componentWillMount() {
            var _this = this;
        ...
        value: function render() {
            return React.createElement(
                'div',
                { className: 'panel-body ' + (this.state.fetching ? 'blurry' : '') },
                React.createElement(
                    'div',
                    { className: 'row mb5' },
                    React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            this.state.countPercentage,
                            ' %'
                        ),
                        React.createElement(
                            'label',
                            { className: 'dashboard' },
                            '(Customer Count Percentage for last 7 days)'
                        )
                    )
                )
            );
...
var FormSearch = (function (_React$Component) {
    ...
    function FormSearch(props) {
        ...
        _get(Object.getPrototypeOf(FormSearch.prototype), 'constructor', this).call(this, props);
        this.state = { reportExisiting: false, date_from: '' };
    }

    _createClass(FormSearch, [{
        key: 'clientBrandFromDatePicker',
        value: function clientBrandFromDatePicker() {
            $('#from').datepicker({
                autoclose: true,
                minDate: new Date()
        ...
        key: 'clientBrandToDatePicker',
        value: function clientBrandToDatePicker() {
            $('#to').datepicker({
                autoclose: true,
                minDate: new Date()
            }).on('change', function (evt) {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'col-xs col-lg-6' },
                            React.createElement('input', { type: 'text', id: 'from', placeholder: 'From', onChange: this.getDateFrom.bind(this) })
                        ),
                        React.createElement(
                            'div',
                            { className: 'col-xs col-lg-6' },
                            React.createElement('input', { type: 'text', id: 'to', placeholder: 'To' })
                        )
                    )
                ),
        ...
        key: 'getDateFrom',
        value: function getDateFrom(event) {
...
var ItemAndCostAnalysis = (function (_React$Component) {
    _inherits(ItemAndCostAnalysis, _React$Component);

    function ItemAndCostAnalysis(props) {
        _classCallCheck(this, ItemAndCostAnalysis);

        _get(Object.getPrototypeOf(ItemAndCostAnalysis.prototype), 'constructor', this).call(this, props);
        this.state = {
            fetching: false,
            display: 'week',
            purchasesLastWeek: [],
    ...
    _createClass(ItemAndCostAnalysis, [{
        key: 'searchPurchases',
        value: function searchPurchases() {
            var _this = this;
            ...
            if (this.props.branchUser) {
                ...
                if (this.state.branch.length === 0 && $("#q_date_range").val() === '') {
                    return;
                }
                $.ajax({
                    ...
                    data: {
                        ...
                        branches: this.state.branch.length > 0 ? this.state.branch.map(function (x) {
                            return x.value;
                        }) : []
                    },
                    success: function (data) {
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'panel-heading border pb45' },
                    React.createElement(
                        'div',
                        { className: 'pull-left mt7' },
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: this.props.branchUser ? 'col-xs-12' : 'col-xs-6' },
                            React.createElement(
                                'div',
                                { className: 'pull-right' },
                                React.createElement('i', { onClick: this.searchPurchases.bind(this), id: 'search', className: 'fa fa-search fa-sm', 'aria-hidden': 'true' })
                            ),
                            React.createElement(
                                'div',
                                { className: 'pull-right' },
                                React.createElement('input', { className: 'form-control drp', placeholder: 'Custom Search', type: 'text', id: 'q_date_range' })
                            )
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            { type: 'button', onClick: function () {
                                    return _this2.setState({ display: 'week', purchases: [] });
                                }, className: this.state.display === 'week' ? 'tablinks active' : 'tablinks' },
                            'This Week\'s (',
                            this.state.lwRange,
                            ')'
                        ),
                        React.createElement(
                            'button',
                            { type: 'button', onClick: function () {
                                    return _this2.setState({ display: 'month', purchases: [] });
                                }, className: this.state.display === 'month' ? 'tablinks active' : 'tablinks' },
                            'This Month\'s (',
                            this.state.tmRange,
                            ')'
                        )
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'table',
                            { className: 'table table-bordered table-striped mb0' },
                            React.createElement(
                                'thead',
                                null,
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'th',
                                        { colSpan: '3', className: 'ica-primary-thead' },
                                        'Beginning Inventory'
                                    ),
                                    React.createElement(
                                        'th',
                                        { colSpan: '4', className: 'ica-primary-thead' },
                                        'Total Purchases'
                                    ),
                                    React.createElement(
                                        'th',
        ...
        key: 'showBranchFilter',
        value: function showBranchFilter() {
            var _this3 = this;
            ...
            return React.createElement(
                'div',
                { className: 'col-xs-6' },
                React.createElement(Select.Creatable, {
                    multi: true,
                    name: 'supplier_names',
                    ...
                    onChange: function (value) {
                        return _this3.setState({ branch: value });
                    },
                ...
                if (this.state.purchases.length === 0) {
                    if (this.state.display === 'week') {
                        return React.createElement(
                            'tbody',
                            null,
                            this.state.purchasesLastWeek.map(function (purchase, index) {
                                return [React.createElement(
                                    'tr',
                                    { key: index },
                                    React.createElement(
                                        'td',
                                        { className: 'category', colSpan: '18' },
                                        purchase.parent_category
                                    )
                                ), purchase.purchases.map(function (pur, i) {
                                    return [React.createElement(
                                        'tr',
                                        { key: i },
                                        React.createElement('td', { className: 'subcategory', colSpan: '1' }),
                                        React.createElement(
                                            'td',
                                            { className: 'subcategory', colSpan: '17' },
                                            pur.subcategory
                                        )
                                    ), pur.purchase_items.map(function (purchase_item, item) {
                                        return React.createElement(
                                            'tr',
                                            { key: item },
                                            ...
                                            React.createElement(
                                                'td',
                                                null,
                                                purchase_item.purchase_item_amount
                                            ),
                                            React.createElement(
                                                'td',
                                                null,
                                                purchase_item.item_total_net
                                            )
                                        );
                                    }), React.createElement(
                                        'tr',
                                        { key: i + 1, className: 'bg-total' },
                                        React.createElement('td', { className: 'subcategory', colSpan: '1' }),
                                        React.createElement(
                                            'td',
                                            { className: 'subcategory', colSpan: '8' },
                                        ...
                                        React.createElement(
                                            'td',
                                            { className: 'label-total-num subcategory', colSpan: '1' },
                                            pur.total_amount_per_category
                                        ),
                                        React.createElement('td', { className: 'subcategory', colSpan: '8' })
                                    )];
                                }), React.createElement(
                                    'tr',
                                    { key: index + 1, className: 'bg-total' },
                                    React.createElement(
                                        'td',
                                        { className: 'category', colSpan: '9' },
                                        'Total Amount for Category ',
                                        purchase.parent_category
                                    ),
                                    React.createElement(
                                        'td',
                                        { className: 'label-total-num category', colSpan: '1' },
                                        purchase.total_amount_within_month
                                    ),
                                    React.createElement('td', { className: 'category', colSpan: '8' })
                                )];
                            }),
                            React.createElement(
                                'tr',
                                ...
                                React.createElement(
                                    'td',
                                    { className: 'total-overall', colSpan: '9' },
                                    'Total'
                                ),
                                React.createElement(
                                    'td',
                                    { className: 'label-total-num total-overall', colSpan: '1' },
                                    this.state.lastWeekTotal
                                ),
                                React.createElement('td', { className: 'total-overall', colSpan: '8' })
                            )
                        );
                    }
                    return React.createElement(
                        'tbody',
                        null,
                        this.state.purchaseLastMonth.map(function (purchase, index) {
                            return [React.createElement(
                                'tr',
                                { key: index },
                                React.createElement(
                    ...
                    return React.createElement(
                        'tbody',
                        null,
                        this.state.purchases.map(function (purchase, index) {
                            return [React.createElement(
                                'tr',
                                { key: index },
                                React.createElement(
        ...
        key: 'fetchDefaultData',
        value: function fetchDefaultData() {
            var _this4 = this;
...
var PurchaseList = (function (_React$Component) {
    _inherits(PurchaseList, _React$Component);

    function PurchaseList(props) {
        _classCallCheck(this, PurchaseList);

        _get(Object.getPrototypeOf(PurchaseList.prototype), 'constructor', this).call(this, props);
        this.state = {
            fetching: false,
            suppliers: [],
            categories: [],
    ...
    _createClass(PurchaseList, [{
        ...
        value: function searchPurchases() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    suppliers: this.state.supplier.map(function (x) {
                        return x.input;
                    }),
                    branches: this.state.branch.map(function (x) {
                        return x.input;
                    }),
                    purchase_items: this.state.item.map(function (x) {
                        return x.input;
                    }),
        ...
        key: 'handleNextPurchaseOrders',
        value: function handleNextPurchaseOrders() {
            var _this2 = this;
            ...
            if (this.state.searching) {
                $.ajax({
                    ...
                    success: function (data) {
                        _this2.setState({
                            purchases: [].concat(_toConsumableArray(_this2.state.purchases), _toConsumableArray(data.purchases)), nextPage: data.next_page, fetching: false
                        });
                    }
                });
            } else {
        ...
        key: 'searchForItem',
        value: function searchForItem(value) {
            var _this3 = this;

            this.setState({ category: value });
            var ids = [];
            value.map(function (x) {
                return ids.push(x.input);
            });
            $.ajax({
                ...
                method: 'GET',
                success: function (data) {
                    _this3.setState({ items: data.items });
                }
            });
        }
    }, {
        key: 'downloadExcel',
        value: function downloadExcel(event) {
            var items = this.state.item.map(function (x) {
                return '&purchase_items[]=' + x.input;
            }).toString();
            var branches = this.state.branch.map(function (x) {
                return '&branches[]=' + x.input;
            }).toString();
            var suppliers = this.state.supplier.map(function (x) {
                return '&suppliers[]=' + x.input;
            }).toString();
            var dates = $("#q_purchase_date_cont").val().split(" - ").map(function (x) {
                return '&date[]=' + x;
            }).toString();
            if (this.state.searching) {
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'panel-body ml15 mr15' },
                        this.renderFilters()
                    )
                ),
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'a',
                                { onClick: this.downloadExcel.bind(this), className: 'btn btn-success btn-round btn-outline' },
                                React.createElement('i', { className: 'icon-glyph-162 f14 mr5' }),
                                ' Download Excel '
                            ),
                            React.createElement(
                                'a',
                                { onClick: this.downloadPdf.bind(this), className: 'btn btn-success btn-round btn-outline' },
                                React.createElement('i', { className: 'icon-glyph-162 f14 mr5' }),
                                ' Download PDF '
                            )
                        )
            ...
            if (this.props.isBranchUser) {
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'col-md-6 col-xs-6 mb5' },
                            React.createElement(
                                'label',
                                { htmlFor: 'category' },
                                'Category'
                        ...
                        React.createElement(
                            ...
                            React.createElement(Select.Creatable, {
                                ...
                                onChange: function (value) {
                                    return _this5.setState({ item: value });
                                },
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(Select.Creatable, {
                                ...
                                onChange: function (value) {
                                    return _this5.setState({ supplier: value });
                                },
                        ...
                        React.createElement(
                            ...
                            React.createElement('input', { className: 'form-control', placeholder: 'Input invoice', value: this.state.invoice, onChange: function (e) {
                                    return _this5.setState({ invoice: e.target.value });
                                } })
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement('input', { className: 'form-control drp', placeholder: 'Search', type: 'text', name: 'date_range', id: 'q_purchase_date_cont' })
                        )
                    ),
                    React.createElement(
                        'div',
                        ...
                        React.createElement(
                            'div',
                            { className: 'row mb10', style: { marginRight: '15px' } },
                            React.createElement(
                                'div',
                                { className: 'col-xs-12' },
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'button',
                                        { onClick: this.searchPurchases.bind(this), className: 'btn btn-primary', type: 'button' },
                                        React.createElement('i', { className: 'fa fa-search', 'aria-hidden': 'true' }),
                                        React.createElement('span', { className: 'gap1' }),
                                        'Search'
                                    ),
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(Select.Creatable, {
                            ...
                            options: this.state.branches,
                            onChange: function (value) {
                                return _this5.setState({ branch: value });
                            },
                            value: this.state.branch
                        })
                    ),
        ...
        value: function displayResetButton() {
            if (this.state.searching || this.state.branch.length > 0 || this.state.supplier.length > 0 || this.state.invoice !== '' || this.state.item.length > 0 || $("#q_purchase_date_cont").val() !== '') {
                return React.createElement(
                    'button',
                    { onClick: this.resetEverything.bind(this), className: 'btn btn-default' },
                    'Reset'
                );
            }
        }
        ...
        value: function renderButton() {
            if (this.state.fetching) {
                return React.createElement('i', { className: 'fa fa-spinner fa-spin fa-lg fa-fw' });
            }
            if (this.state.purchases.length === 0) {
                return React.createElement(
                    'i',
            ...
            return React.createElement(
                'a',
                { className: 'view-more', onClick: this.handleNextPurchaseOrders.bind(this) },
                'See more..'
            );
        }
    }, {
        key: 'renderTotalsWhenItemSearch',
        value: function renderTotalsWhenItemSearch() {
            if (this.state.searching) {
                return React.createElement(
                    'tbody',
                    null,
                    React.createElement(
                        ...
                        React.createElement(
                            'td',
                            { className: 'text-right label-total', colSpan: '7' },
                            'Total VAT'
                        ),
                        React.createElement(
                            'td',
                            { className: 'label-total-num', colSpan: '2' },
                            this.state.itemTotalVat
                        )
                    ),
                    React.createElement(
                        'tr',
        ...
        value: function renderData() {
            ...
            if (this.state.searching) {
                return this.state.purchases.map(function (purchase, index) {
                    return React.createElement(
                        'tbody',
                        { key: index },
                        purchase.purchase_items.map(function (purchase_item, index) {
                            return React.createElement(
                                'tr',
                                { key: index },
                                React.createElement(
                                ...
                                React.createElement(
                                    'td',
                                    null,
                                    purchase_item.item_total_amount
                                )
                            );
                        })
                    );
        ...
        value: function fetchData() {
            ...
            $.ajax({
                ...
                method: 'GET',
                success: function (data) {
                    _this6.setState({ items: data.items, purchases: data.purchases, fetching: false, nextPage: data.next_page });
                }
            });
        }
    }]);
...
var PurchaseOrderApproved = (function (_React$Component) {
    _inherits(PurchaseOrderApproved, _React$Component);

    function PurchaseOrderApproved(props) {
        _classCallCheck(this, PurchaseOrderApproved);

        _get(Object.getPrototypeOf(PurchaseOrderApproved.prototype), 'constructor', this).call(this, props);
        this.state = { purchaseOrders: [], fetching: false, nextPage: null };
    }

    _createClass(PurchaseOrderApproved, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.fetchData();
        }
            ...
            $.ajax({
                ...
                success: function (data) {
                    _this.setState({
                        fetching: false,
                        nextPage: data.next_page,
                        purchaseOrders: [].concat(_toConsumableArray(_this.state.purchaseOrders), _toConsumableArray(data.approved_purchase_orders))
                    });
                }
            });
        }
        ...
        key: 'renderTableDataForAdmins',
        value: function renderTableDataForAdmins(purchaseOrders) {
            var _this2 = this;

            if (purchaseOrders.length != 0) {
                return purchaseOrders.map(function (po, index) {
                    return React.createElement(
                        'tr',
                        { key: index },
                        React.createElement(
                        ...
                        React.createElement(
                            'td',
                            { className: 'action', 'data-title': 'Action' },
                            React.createElement(
                                'a',
                                { className: 'btn btn-default btn-xs mb10 mr2 swal-warning-confirm', 'data-tt': 'tooltip', 'data-placement': 'top', 'data-original-title': 'View', href: '/purchase_orders/' + po.id + '/purchase_order_items' },
                                React.createElement('i', { className: 'icon-glyph-41 f14' })
                            ),
                            React.createElement(
                                'a',
                                { onClick: function () {
                                    ...
                                    }, className: 'btn btn-default btn-xs mb10 mr2 swal-warning-confirm', 'data-tt': 'tooltip', 'data-placement': 'top', 'data-original-title': 'Delete', 'data-confirm': 'Are you sure?', 'data-remote': 'true', rel: 'nofollow', 'data-method': 'delete', href: '/purchase_orders/' + po.id },
                                React.createElement('i', { className: 'icon-glyph-76 f14' })
                            )
                        )
                    );
        ...
        value: function fetchData() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    _this3.setState({
                        purchaseOrders: data.approved_purchase_orders, fetching: false, nextPage: data.next_page
                    });
                }
            });
        }
...
var PurchaseOrderOnhold = (function (_React$Component) {
    _inherits(PurchaseOrderOnhold, _React$Component);

    function PurchaseOrderOnhold(props) {
        _classCallCheck(this, PurchaseOrderOnhold);

        _get(Object.getPrototypeOf(PurchaseOrderOnhold.prototype), 'constructor', this).call(this, props);
        this.state = { purchaseOrders: [], fetching: false, nextPage: null };
    }

    _createClass(PurchaseOrderOnhold, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.fetchData();
        }
            ...
            $.ajax({
                ...
                success: function (data) {
                    _this.setState({
                        fetching: false,
                        nextPage: data.next_page,
                        purchaseOrders: [].concat(_toConsumableArray(_this.state.purchaseOrders), _toConsumableArray(data.on_hold_pos))
                    });
                }
            });
        }
                ...
                return purchaseOrders.map(function (po, index) {
                    return React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'a',
                                { className: 'btn btn-default btn-xs mb10 mr2', 'data-tt': 'tooltip', 'data-placement': 'top', 'data-original-title': 'View purchase_order Items', href: '/purchase_orders/' + po.id + '/purchase_order_items' },
                                React.createElement('i', { className: 'icon-glyph-41 f14' })
                            ),
                            React.createElement(
                                'a',
                                { className: 'btn btn-default btn-xs mb10 mr2', 'data-tt': 'tooltip', 'data-placement': 'top', 'data-original-title': 'Approve', rel: 'nofollow', 'data-method': 'patch', href: 'purchase_orders/' + po.id + '/approve' },
                                React.createElement('i', { className: 'fa green icon-glyph-26 f14' })
                            ),
                            React.createElement(
                                'a',
                                { className: 'btn btn-default btn-xs mb10 mr2', 'data-tt': 'tooltip', 'data-placement': 'top', 'data-original-title': 'Reject', rel: 'nofollow', 'data-method': 'patch', href: 'purchase_orders/' + po.id + '/reject' },
                                React.createElement('i', { className: 'icon-glyph-27 f14' })
                            ),
                            React.createElement(
                                'a',
                                { onClick: function () {
...
var PurchaseOrderRejected = (function (_React$Component) {
    _inherits(PurchaseOrderRejected, _React$Component);

    function PurchaseOrderRejected(props) {
        _classCallCheck(this, PurchaseOrderRejected);

        _get(Object.getPrototypeOf(PurchaseOrderRejected.prototype), 'constructor', this).call(this, props);
        this.state = { purchaseOrders: [], fetching: false, nextPage: null };
    }

    _createClass(PurchaseOrderRejected, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.fetchData();
        }
        ...
        value: function handleNextPurchaseOrders() {
            ...
            this.setState({ fetching: true });
            $.ajax({
                url: '/api/purchase_order_summary/get_rejected_pos.json?page=' + this.state.nextPage,
                method: 'GET',
                success: function (data) {
                    _this.setState({
                        fetching: false,
                        nextPage: data.next_page,
                        purchaseOrders: [].concat(_toConsumableArray(_this.state.purchaseOrders), _toConsumableArray(data.rejected_pos))
                    });
                }
            });
        }
                ...
                return purchaseOrders.map(function (po, index) {
                    return React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'a',
                                { className: 'btn btn-default btn-xs mb10 mr2', 'data-tt': 'tooltip', 'data-placement': 'top', 'data-original-title': 'Hold', rel: 'nofollow', 'data-method': 'patch', href: '/purchase_orders/' + po.id + '/hold', 'aria-describedby': 'tooltip63628' },
                                React.createElement('i', { className: 'fa blue icon-glyph-28 f14' })
                            ),
                            React.createElement(
                                'a',
                                { onClick: function () {
        ...
        value: function fetchData() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    _this3.setState({
                        purchaseOrders: data.rejected_pos, nextPage: data.next_page, fetching: false
                    });
                }
            });
        }
...
var PurchaseOrderSummary = (function (_React$Component) {
    _inherits(PurchaseOrderSummary, _React$Component);

    function PurchaseOrderSummary(props) {
        _classCallCheck(this, PurchaseOrderSummary);

        _get(Object.getPrototypeOf(PurchaseOrderSummary.prototype), 'constructor', this).call(this, props);
        this.state = { purchaseOrders: [], fetching: false, nextPage: null };
    }

    _createClass(PurchaseOrderSummary, [{
        key: 'handleNextPurchaseOrders',
        value: function handleNextPurchaseOrders() {
            var _this = this;
            ...
            $.ajax({
                ...
                success: function (data) {
                    _this.setState({
                        fetching: false,
                        nextPage: data.next_page,
                        purchaseOrders: [].concat(_toConsumableArray(_this.state.purchaseOrders), _toConsumableArray(data.purchase_orders))
                    });
                }
            });
        }
        ...
        key: 'renderHeader',
        value: function renderHeader(role) {
            return React.createElement(
                'tr',
                { className: 'bg-thead' },
                React.createElement(
        ...
        key: 'renderTableForBranchUsers',
        value: function renderTableForBranchUsers(purchaseOrders) {
            var _this2 = this;
                ...
                return purchaseOrders.map(function (po, index) {
                    return React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'a',
                                { className: 'btn btn-default btn-xs mb10 mr2 swal-warning-confirm', 'data-tt': 'tooltip', 'data-placement': 'top', 'data-original-title': 'View', rel: 'nofollow', href: '/purchase_orders/' + po.id + '/purchase_order_items' },
                                React.createElement('i', { className: 'icon-glyph-41 f14' })
                            ),
                            React.createElement(
                                'a',
            ...
            if (purchaseOrders) {
                return purchaseOrders.map(function (po, index) {
                    return React.createElement(
                        ...
                        React.createElement(
                            'td',
                            { className: 'action', 'data-title': 'PO No.' },
                            po.po_number ? '---' : po.po_number
                        ),
                        React.createElement(
                            'td',
...
var PurchaseOrders = (function (_React$Component) {
    _inherits(PurchaseOrders, _React$Component);

    function PurchaseOrders(props) {
        _classCallCheck(this, PurchaseOrders);

        _get(Object.getPrototypeOf(PurchaseOrders.prototype), 'constructor', this).call(this, props);
        this.state = {
            purchaseOrders: [],
            poNumber: '',
            status: '',
    ...
    _createClass(PurchaseOrders, [{
        key: 'searchPurchaseOrder',
        value: function searchPurchaseOrder() {
            var _this = this;
            ...
            $.ajax({
                ...
                data: {
                    ...
                    items: this.state.item.map(function (x) {
                        return x.value;
                    }),
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'form',
                            { action: '/purchase_orders_summary', acceptCharset: 'UTF-8', method: 'get' },
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'div',
                                    { className: 'col-xs-4 mb5' },
                                    React.createElement(
                                        'label',
                                        { htmlFor: 'q[po_number_matches]' },
                                        'PO Number'
                                    ),
                                    React.createElement('input', {
                                        ...
                                        onChange: function (e) {
                                            return _this3.setState({ poNumber: e.target.value });
                                        },
                                ...
                                React.createElement(
                                    ...
                                    React.createElement('input', {
                                        ...
                                        className: 'form-control',
                                        onChange: function (e) {
                                            return _this3.setState({ status: e.target.value });
                                        },
                                ...
                                React.createElement(
                                    ...
                                    React.createElement('input', {
                                        ...
                                        className: 'form-control',
                                        onChange: function (e) {
                                            return _this3.setState({ creator: e.target.value });
                                        },
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(Select.Creatable, {
                                        ...
                                        options: this.state.suppliers,
                                        onChange: function (value) {
                                            return _this3.setState({ supplier: value });
                                        },
                                        value: this.state.supplier
                                    })
                                ),
                                React.createElement(
                                    ...
                                    React.createElement(Select.Creatable, {
                                        ...
                                        options: this.state.items,
                                        onChange: function (value) {
                                            return _this3.setState({ item: value });
                                        },
                                        value: this.state.item
                                    })
                                )
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'div',
                                    { className: 'col-md-6 mb5' },
                                    React.createElement(
                                        'label',
                                        null,
                                        'Date Filter'
                                    ),
                                    React.createElement('input', { className: 'form-control drp', placeholder: 'Search', type: 'text', name: 'date_range', id: 'date_range' })
                                )
                            ),
                            React.createElement(
                                'div',
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            'button',
                                            { onClick: this.searchPurchaseOrder.bind(this), className: 'btn btn-primary', type: 'button' },
                                            React.createElement('i', { className: 'fa fa-search', 'aria-hidden': 'true' }),
                                            React.createElement('span', { className: 'gap1' }),
                                            'Search'
                                        ),
        ...
        key: 'displayResetButton',
        value: function displayResetButton() {
            if (this.state.searching) return React.createElement(
                'button',
                { type: 'button', onClick: this.resetEveything.bind(this), className: 'btn btn-default' },
                'Reset'
            );
        }
    }, {
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'button',
                                { className: 'btn btn-success btn-round btn-outline' },
                                React.createElement('i', { className: 'icon-glyph-162 f14 mr5' }),
                                ' Download PDF '
                            )
                        )
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'center',
                                null,
                                React.createElement('i', { className: 'fa fa-spinner fa-spin fa-2x dark-blue', 'aria-hidden': 'true' })
                            )
                        )
                    )
                );
            ...
            if (this.state.searching && this.state.totalAmount) {
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'td',
                            { colSpan: '9', 'data-title': 'Total Amount' },
                            'Total Amount'
                        ),
                        React.createElement(
                            'td',
                            { colSpan: '2', 'data-title': 'Total Amount' },
        ...
        value: function renderInformation() {
            ...
            if (this.state.searching) {
                return this.state.purchaseOrders.map(function (po, index) {
                    return React.createElement(
                        'tbody',
                        { key: index },
                        po.po_items.map(function (poi, ind) {
                            return React.createElement(
                                'tr',
                                { key: ind },
                                React.createElement(
                                    'td',
                                    { 'data-title': 'PO Number' },
                                    po.po_number
                                ),
                                React.createElement(
                                    'td',
            ...
            return this.state.purchaseOrders.map(function (po, index) {
                return React.createElement(
                    ...
                    React.createElement(
                        'tr',
                        { key: index, className: 'total-amount' },
                        React.createElement(
                            'td',
                            { colSpan: '9', 'data-title': 'Total Amount' },
                            'Total Amount'
        ...
        key: 'fetchPurchaseOrders',
        value: function fetchPurchaseOrders() {
            var _this4 = this;
...
var RevenuesDashboard = (function (_React$Component) {
    _inherits(RevenuesDashboard, _React$Component);

    function RevenuesDashboard(props) {
        _classCallCheck(this, RevenuesDashboard);

        _get(Object.getPrototypeOf(RevenuesDashboard.prototype), 'constructor', this).call(this, props);
        this.state = {
            averageRevenues: 0, fetching: false, lastWeekRevenues: 0, revenuesPercentage: 0
        };
    }

    _createClass(RevenuesDashboard, [{
        key: 'componentWillMount',
        value: function componentWillMount() {
            var _this = this;
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement('span', { className: 'space' }),
                            this.state.revenuesPercentage,
                            ' %'
                        ),
                        React.createElement(
                            'label',
                            { className: 'dashboard' },
                            '(Revenue Percentage for last 7 days)'
                        )
                    )
                )
            );
...
var SaleReportLink = (function (_React$Component) {
    _inherits(SaleReportLink, _React$Component);

    function SaleReportLink(props) {
        _classCallCheck(this, SaleReportLink);

        _get(Object.getPrototypeOf(SaleReportLink.prototype), "constructor", this).call(this, props);
    }

    _createClass(SaleReportLink, [{
        key: "render",
        value: function render() {
            return React.createElement(
                "a",
                { className: "sale-report-link", href: "/sale_reports/" + this.props.saleReport.id, "data-remote": "true" },
                "View: ",
                this.props.saleReport.title
            );
        }
    }]);

    return SaleReportLink;
})(React.Component);
var _createClass = (function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ('value' in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; })();
...
var SalesDashboard = (function (_React$Component) {
    _inherits(SalesDashboard, _React$Component);

    function SalesDashboard(props) {
        _classCallCheck(this, SalesDashboard);

        _get(Object.getPrototypeOf(SalesDashboard.prototype), 'constructor', this).call(this, props);
        this.state = {
            averageSales: 0, fetching: false, lastWeekSales: 0, salesPercentage: 0
        };
    }

    _createClass(SalesDashboard, [{
        key: 'componentWillMount',
        value: function componentWillMount() {
            var _this = this;
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'label',
                            { className: 'dashboard' },
                            '(Sales Percentage for last 7 days)'
                        )
                    )
                )
            );
...
var SaveButton = (function (_React$Component) {
    ...
    function SaveButton(props) {
        ...
        _get(Object.getPrototypeOf(SaveButton.prototype), 'constructor', this).call(this, props);
    ...
    _createClass(SaveButton, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'button',
                    { className: 'btn btn-default', id: 'reset', onClick: this.resetAll.bind(this), 'data-tt': 'tooltip', 'data-original-title': 'Reset' },
                    'Reset'
                ),
                React.createElement('span', { className: 'gap05' }),
                this.renderButton(),
        ...
        value: function renderButton() {
            if (this.state.status === 'Saving' || this.state.status === 'Saved') {
                return React.createElement(
                    'button',
                    { disabled: 'true', id: 'save-report', onClick: this.saveReport.bind(this), className: 'btn btn-primary' },
                    this.renderLabel(),
                    React.createElement('span', { className: 'gap05' }),
                    this.renderIcon()
                );
            ...
            return React.createElement(
                'button',
                { id: 'save-report', onClick: this.saveReport.bind(this), className: 'btn btn-primary' },
                this.renderLabel(),
                React.createElement('span', { className: 'gap05' }),
                this.renderIcon()
            );
        ...
        key: 'saveReport',
        value: function saveReport(event) {
            var _this = this;
        ...
        key: 'renderSaleReportLink',
        value: function renderSaleReportLink() {
            if (this.state.sale_report === null || this.state.status === 'Save Report') {
                return;
            }
            return React.createElement(
                'p',
                { className: 'sale-report show-link' },
                this.state.sale_report ? React.createElement(SaleReportLink, { saleReport: this.state.sale_report }) : 'No existing Sales for ' + this.state.title
            );
        }
    }, {
        key: 'renderIcon',
        value: function renderIcon() {
            return React.createElement('i', { className: 'fa ' + (this.state.show ? 'fa-spinner fa-spin fa-1x fa-fw' : '') });
        }
    }, {
        key: 'renderLabel',
